	...
	<div id="container">
		...
		<section>
			<div id="content">
				...
				<input placeholder="enter a message..." style="margin: 0px; width: 200px;"
				...
				<button type="button" class="button button1" onclick="myFunction(); ">Send</button>
     			...
     			style="width:650px; height:400px;"></iframe>
				 ...
				 // The Browser API key obtained from the Google Developers Console.
			      var developerKey = 'AIzaSyBXPA8wIUPIas4D8fiPm67Uy6mwUa2J6iM';

			      // The Client ID obtained from the Google Developers Console. Replace with your own Client ID.
			      var clientId = "832015913752-b2oe9h755j5hd6joqm3n1dmpi9o8qona.apps.googleusercontent.com"
